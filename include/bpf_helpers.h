// Note: This file should be dropped and replaced with "#include <bpf/bpf_helpers.h>"
// once there is an official libbpf package for Ubuntu LTS (currently Ubuntu 20.04).
